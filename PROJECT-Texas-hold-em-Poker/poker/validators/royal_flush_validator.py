...
class RoyalFlushValidator(StraightValidator):
    ...
    def is_valid(self):
        ...
        return len(self._checking_weather_a_straight_have_Royal_flush_or_not)>=1 and self._checking_weather_a_straight_have_Royal_flush_or_not[-1][-1].rank=="Ace"

  
    def valid_card(self):
        return self._checking_weather_a_straight_have_Royal_flush_or_not[-1]



    @property
    def _checking_weather_a_straight_have_Royal_flush_or_not(self):
        card_suit_count={} 
